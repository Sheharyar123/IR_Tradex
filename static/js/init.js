...
function kura_tm_news_popup() {
  ...
  button.on("click", function () {
    ...
    modalBox
      ...
      .after('<div class="details">' + details + "<div>");
    kura_tm_data_images();
    return false;
  });
  closePopup.on("click", function () {
...
function kura_tm_swiper() {
  ...
  $(".kura_tm_portfolio .portfolio_list,.kura_tm_news .news_list").each(
    function () {
      var element = $(this);
